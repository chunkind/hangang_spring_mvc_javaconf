...
DROP TABLE CLT_PAY_BASE;
DROP TABLE CLT_PAY_DTL_INFO;
...
, GOODS_CD	INT(12)		NOT NULL,
  ...
  ORD_CLM_DTL_SN	VARCHAR(100)	NULL
);
...
CREATE TABLE CLT_ORD_BASE (
    ...
    ORD_CLM_NO    VARCHAR(100)     NOT NULL,
    CLM_SCT_CD    VARCHAR(20)      NULL,
    CLM_STAT_CD   VARCHAR(20)      NULL,
    ORD_STAT      VARCHAR(8)       NULL,
    ORDR_ID       VARCHAR(100)     NULL,
    ...
    ACQR_ADDR     VARCHAR(500)     NULL,
    ACQR_ADDR_DTL VARCHAR(300)     NULL,
    ...
    RGST_ID       VARCHAR(200)     NULL,
    BILL_NUM      INT              NULL,
    PRIMARY KEY (ORD_NO, ORD_CLM_NO)
);


CREATE TABLE CLT_ORD_DTL (
    ORD_CLM_NO       VARCHAR(100)   NOT NULL,
    ORD_CLM_DTL_SN   	INT   		NOT NULL,
	SND_GOODS_QTY		INT         NULL,
    RTN_GOODS_QTY		INT         NULL,
    ...
    RGST_DATE        DATETIME       NULL,
    RGST_ID          VARCHAR(20)    NULL,
    PRIMARY KEY (ORD_CLM_NO, ORD_CLM_DTL_SN)
);

CREATE TABLE CLT_ORD_HIST (
	ORD_NO	VARCHAR(100)	NOT NULL,
	ORD_CLM_NO	VARCHAR(100)	NOT NULL,
	ORD_CLM_DTL_SN   VARCHAR(100)   NOT NULL,
	ORD_STAT	VARCHAR(8)	NULL,
	PROC_DATE	DATETIME	NULL,
	RGST_ID	VARCHAR(200)	NULL,
	RGST_DATE	DATETIME	NULL,
	CLM_RASN	VARCHAR(200)	NULL,
	HIST_MEMO	VARCHAR(2000)	NULL,
	PRIMARY KEY (ORD_NO, ORD_CLM_NO, ORD_CLM_DTL_SN)
);
...
CREATE TABLE CLT_PAY_BASE (
	PAY_SN          BIGINT AUTO_INCREMENT PRIMARY KEY,
	ORD_NO          VARCHAR(50) NOT NULL,
	ORD_CLM_NO      VARCHAR(50) NOT NULL,
	PAY_STATE_CD    VARCHAR(20) NOT NULL, 
	...
	VERIFICATION    TEXT,
	CURRENCY        VARCHAR(3),
	BUYER_NM        VARCHAR(100),
	BUYER_TEL       VARCHAR(20),
	BUYER_EMAIL     VARCHAR(255),
	VACT_BANK_NAME  VARCHAR(20),
	_DEVICE 		VARCHAR(20),
	RGST_DATE       DATETIME DEFAULT CURRENT_TIMESTAMP,
	UPDT_DATE       DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);


CREATE TABLE CLT_PAY_DTL_INFO (
	PAY_DTL_INFO_SEQ BIGINT AUTO_INCREMENT PRIMARY KEY,
	PAY_SN           BIGINT NOT NULL,
	ORD_NO          VARCHAR(50) NOT NULL,
	ORD_CLM_DTL_SN  VARCHAR(50),
	GOODS_NM        VARCHAR(255) NOT NULL,
	GOODS_PRC       DECIMAL(10,2) NOT NULL,
