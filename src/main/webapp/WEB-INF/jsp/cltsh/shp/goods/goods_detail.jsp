...
<link href="/css/cltsh/product.css" rel="stylesheet">
<!-- 상품 중간 메뉴 (상단) -->
...
<section id="product_main">
    <div class="product_image">
        <img alt="메인이미지" src="${detail.imgPath}${detail.imgNm} " width="348" height="349">
    </div>
...
<section id="product_detail">
    <div>
        <div class="product_detail_image">
           	<img src="${detail.imgPath}${detail.imgNm}" width="697" height="697"/></br>
        </div>
        ...
        <div class="product_detail_document">
            <h3>사이즈 정보</h3>
            <img src="/img/cltsh/top_size.png" width="800" height="800"/></br>
            <img src="/img/cltsh/pants_size.png" width="800" height="800"/>
        </div>
    </div>
</section>
<!-- 상품 리뷰 -->
<section id="product_review">
	<div>
		...
		<button class="product_review_button" onclick="location.href='/cltsh/main/mainDrssList.do'">더 많은 드레스룸 보기 ></button>
	</div>
</section>
<!-- 상품 QnA -->
    ...
    <div>
        <div class="product_qna_titlebar">
            ...
            <div class="product_qna_buttonbar">
                <button class="product_qna_button" onclick="location.href='/cltsh/qna/goodsDtlQnaInsert.do?goodsCd='+${detail.goodsCd}">문의 내용 작성하기</button>
            </div>
        </div>
