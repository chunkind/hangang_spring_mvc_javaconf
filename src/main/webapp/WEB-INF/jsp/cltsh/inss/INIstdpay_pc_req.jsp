...
<%
	...
	String useChkfake			= "Y";									// verification 검증 여부 ('Y' , 'N')
...
<body class="wrap">
	...
	<!-- 본문 -->
	<main class="col-8 cont" id="bill-01"> <!-- 페이지타이틀 -->
	<section class="mb-5">
		<div class="tit">
			<h2>일반결제</h2>
		...
		<div class="card">
			...
			<form name="" id="SendPayForm_id" method="post" class="mt-5">
				<div class="row g-3 justify-content-between" style="-bs-gutter-x: 0rem;">
					...
					<input type="hidden" name="goodsNm" value="${pvo.goodsNm}">
					<input type="hidden" name="goodsCd" value="${pvo.goodsCd}">
					<input type="hidden" name="payMny" value="${pvo.payMny}">
					...
					<label class="col-10 col-sm-9 input">
						<input type="text"name="mid" value="<%=mid%>"></label> 
					
					<label class="col-10 col-sm-2 input param" style="border: none;">oid</label>
					<label class="col-10 col-sm-9 input">
						<input type="text" name="oid" value="<%=orderNumber%>"></label> 
					...
					<input type="hidden" name="useChkfake" value="<%=useChkfake%>">
					...
					<!-- <input type="hidden" name="returnUrl" value="http://dudtlr2331.cafe24.com/cltsh/order/payPcReturn.do">
                            <input type="hidden" name="closeUrl" value="http://dudtlr2331.cafe24.com//cltsh/order/payPcClose.do"> -->
