                ...
                <div class="card">
                    ...
                    <form name="" id="SendPayForm_id" method="post" class="mt-5">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
				    		...
				    		<input type="hidden" name="returnUrl" value="http://dudtlr2331.cafe24.com/INIstdpay_pc_return.jsp">
                            <input type="hidden" name="closeUrl" value="http://dudtlr2331.cafe24.com/close.jsp
                            ">
