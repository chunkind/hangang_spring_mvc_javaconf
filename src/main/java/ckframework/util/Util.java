...
public class Util {
	...
	public static final String CD0000 = "SUCCESS";
	public static final String VL0000 = "성공.";
	public static final String CD0001 = "FAIL";
	public static final String VL0001 = "실패.";
	public static final String CD0002 = "emptySession";
	public static final String VL0002 = "세션이 없습니다.";
	...
	public static void httpTrans(String strUrl) throws NoSuchAlgorithmException, KeyManagementException {
		URL url = null;
...
//			System.err.println(BRNO + " 사용불가");
	...
	public static void main(String[] args) {
		//isNull
//		System.out.println(isNull(new Object()));
//		String str = "";
