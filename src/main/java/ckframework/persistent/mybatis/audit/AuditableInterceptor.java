package ckframework.persistent.mybatis.audit;

import java.util.Date;
import java.util.Properties;

import ckframework.core.environment.RequestTransactionContextHolder;
import ckframework.domain.entity.AuditableEntity;
import ckframework.interceptors.programidcontext.ProgramIdContextHolder;
import ckframework.security.context.ProjectSecurityContextHolder;
